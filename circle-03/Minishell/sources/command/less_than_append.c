...
/*   Updated: 2022/07/08 23:59:04 by joaribei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/command.h"

char	*command_pre_less_than_append(t_command *invoker, t_command *this)
{
	char	*name;
	...
	if (_command_create_file(invoker, this, O_APPEND))
		return (NULL);
	return (this->name);
}
