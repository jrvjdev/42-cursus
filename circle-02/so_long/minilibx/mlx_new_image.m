...
mlx_img_ctx_t	*add_img_to_ctx(t_mlx_img_list *img, t_mlx_win_list *win)
{
...
void    mlx_put_image_to_window(mlx_ptr_t *mlx_ptr, t_mlx_win_list *win_ptr, t_mlx_img_list *img_ptr, int x, int y)
{
  mlx_img_ctx_t	*imgctx;
...
int mlx_string_put(mlx_ptr_t *mlx_ptr, t_mlx_win_list *win_ptr, int x, int y, int color, unsigned char *string)
{
  mlx_img_ctx_t	*imgctx;
  int		gX;
  int		gY;
